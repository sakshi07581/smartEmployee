    ...
    <table class="table align-middle mb-4 text-center bg-white">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-success rounded-pill" href="{{ route('salaryEdit', $salary->id) }}"><i class="fas fa-pen"></i></a>
                    <a class="btn btn-danger rounded-pill" href="{{ route('salaryDelete', $salary->id) }}"><i class="fas fa-trash"></i> </a>
                </td>
            </tr>
            @endforeach
        </tbody>
