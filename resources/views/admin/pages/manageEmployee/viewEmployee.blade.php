    ...
    <table class="table align-middle text-center bg-white">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $employee->name }}</td>
                <td><img class="avatar p-1 rounded" width="100px" height="100px" src="{{ url('/uploads//' . $employee->employee_image) }}" alt="">
                </td>
                ...
                <td>
                    <a class="btn btn-warning rounded-pill fw-bold text-white"
                        href="{{ route('Employee.profile', $employee->id) }}"><i class="fas fa-eye"></i></a>
                    <a class="btn btn-success rounded-pill fw-bold text-white"
                        href="{{ route('Employee.edit', $employee->id) }}"><i class="fas fa-pen"></i></a>
